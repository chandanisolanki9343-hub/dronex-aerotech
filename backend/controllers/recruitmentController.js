...
export const createApplication = async (req, res) => {
  try {
    ...
    // 1. Send professional confirmation email to the applicant (asynchronously)
    ...
    // 2. Send notification email to the Admin (asynchronously)
    transporter.sendMail({
      from: process.env.EMAIL_USER,
...
export const updateApplicationStatus = async (req, res) => {
  try {
    ...
    // Send selection email to candidate if status is updated to "Selected" (asynchronously)
